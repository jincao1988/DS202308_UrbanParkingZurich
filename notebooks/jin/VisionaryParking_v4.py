...
with streamlit_analytics.track():
    if st.button("Click me to display result",key=1,type='primary'):
        ...
        if coordinates:
            ...
            st.write("Failed to get coordinates, try address in this format: 'Heinrichstrasse 200, 8005 Zurich'")
            sys.exit()
